...
document.getElementById("formCadastro").addEventListener("submit", async (e) => {
    ...
    try {
        ...
        let valorTotal = parcela * 24;

        // Salva na coleção "solicitacoes_pendentes" com todos os campos necessários para o app/painel
        await addDoc(collection(db, "solicitacoes_pendentes"), {
            ...
            valor,
            valorParcela: parcela, // Adicionado para manter compatibilidade exata com o app.js
            parcela,               // Mantido para compatibilidade antiga
            valorTotal,            // Adicionado para o painel de admin ler corretamente
            tipoEmprestimo: "diario",
            totalParcelas: 24,
